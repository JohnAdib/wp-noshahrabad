...
function site5framework_widgets_init() {
	...
	'description' =>'نوار کناری در تمام صفحات بجز صفحه اول قابل نمایش است',
    'id' => 'sidebar',
	...
	'description' =>'نوار پایینی در تمامی صفحات نمایش داده می شود',
    'id' => 'footer_jc',
...
class site5framework_contact_widget extends WP_Widget {
    function __construct() {
        parent::__construct(false, $name = 'Contact Widget', array( 'description' => 'contact widget for your site.' ) );
    }
...
?>
        ...
        <h2 class="widget-title"><?php echo $instance['widget_title']; ?></h2>
	        ...
	        <div class="footer_contact">
	                <div class="caddress"><strong>آدرس</strong> <?php echo $instance['caddress']; ?></div>
	                <div class="cphone"><strong>تلفن</strong> <?php echo $instance['cphone']; ?></div>
	                <div class="cphone"><strong>فکس</strong> <?php echo $instance['cfax']; ?></div>
	                <div class="cemail"><strong>رایانامه</strong> <?php echo $instance['cemail']; ?></div>
	        </div>
