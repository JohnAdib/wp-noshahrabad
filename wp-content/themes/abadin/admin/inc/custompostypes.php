...
$labels = array(
    'name' 					=> __( 'اسلایدر', 'site5framework' ),
    'singular_name' 		=> __( 'Slider Item', 'site5framework' ),
    'add_new' 				=> __( 'افزودن عکس', 'site5framework' ),
    'add_new_item' 			=> __( 'افزودن آیتم به اسلایدر', 'site5framework' ),
    'edit_item' 			=> __( 'ویرایش', 'site5framework' ),
    'new_item' 				=> __( 'افزودن آیتم به اسلایدر', 'site5framework' ),
    'view_item'				=> __( 'لیست تصاویر اسلایدر', 'site5framework' ),
    'search_items' 			=> __( 'جستجوی اسلایدر', 'site5framework' ),
    'not_found' 			=> __( 'هیچ عکسی یافت نشد', 'site5framework' ),
    'not_found_in_trash' 	=> __( 'هیچ عکسی در سطل زباله یافت نشد', 'site5framework' )
);
...
function slider_edit_columns($slider_columns){
	$slider_columns = array(
		...
		"title" 			=> __('عنوان', 'site5framework'),
        "slidelink" 		    => __('لینک به', 'site5framework'),
		"featured_thumbnail" 		=> __('تصویر', 'site5framework'),
	);
