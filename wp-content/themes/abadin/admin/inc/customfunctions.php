...
$themename = $themename['Name'];
    ...
    echo "طراحی توسط <a href=http://mixa.ir/>تیم میکسا</a> ";
}
   ...
   <li <?php comment_class('clearfix'); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div id="comment-<?php comment_ID(); ?>">
	  <div class="comment-meta commentmetadata clearfix">
	    <?php printf(__('<strong>%s</strong>'), get_comment_author_link()) ?><?php edit_comment_link('ویرایش','  ','') ?> <span><?php printf(__('%1$s در ساعت %2$s'), get_comment_date(),  get_comment_time()) ?>
	  </span>
	  </div>
