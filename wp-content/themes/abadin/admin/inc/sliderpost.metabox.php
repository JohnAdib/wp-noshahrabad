...
$meta_box = array(
	...
	'fields' => array(
		...
		array(
			'name' => 'افزودن عکس',
            'desc' => 'لطفا عکس را در ابعاد  940px x 370px آپلود نمایید. بعد از آپلود بر روی گذاشتن در نوشته کلیک کنید',
	...
	foreach ($meta_box['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			case 'radio':
				...
				break;
            case "upload":
            echo '<div class="upload_button_div"> <span id="', $field['id'], '"><a href="#" id="set-post-thumbnail" onclick="jQuery(\'#add_image\').click();return true;" class="button-primary">افزودن عکس</a></b> </span><br />'.$field['desc'].'</div>';
                break;
			case 'checkbox':
