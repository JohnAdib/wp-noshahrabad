...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page('Theme Options', 'تنظیمات پوسته', 'edit_theme_options', 'options-framework','optionsframework_page');
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          ...
          <div class="powered-by">
            <h2><a href="http://mixa.ir/">آماده شده توسط <strong>تیم میکسا</strong></a></h2>
          </div>
        ...
        <div class="of_admin_bar">
			<input type="submit" class="button-primary" name="update" value="ذخیره" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="ریست به پیش فرض" onclick="return confirm( '<?php print esc_js( 'مطمئنید؟ تمام تنظیمات ریست می شوند' ); ?>' );" />
		</div>
<div class="clear"></div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate($input) {
	...
	if ( isset($clean) ) {
		add_settings_error( 'options-framework', 'save_options', 'تنظیمات ذخیره شد', 'updated fade' );
